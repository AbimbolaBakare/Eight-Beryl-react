...
import { MDBMask, Container, MDBRow, MDBCol, MDBBtn, MDBAnimation, MDBNavLink } from 'mdbreact';
                ...
                <Container>
                    <MDBRow>
                        ...
                        <MDBCol lg='4'>
                            ...
                            >
                                <div className='text-dark h-100 serv p-3' >
                                    ...
                                    <div className="text-center mt-5 mb-5 ">
                                        <MDBNavLink className='text-dark' to="/gallery">
